...
mk1.sprite.filename = "__Persoport-no-range__/graphics/equipment/personal-roboport-equipment-nr.png";
...
mk2.sprite.filename = "__Persoport-no-range__/graphics/equipment/personal-roboport-mk2-equipment-nr.png";
