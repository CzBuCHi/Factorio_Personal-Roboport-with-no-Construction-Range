...
mk1.icon = "__Persoport-no-range__/graphics/icons/personal-roboport-equipment-nr.png";
...
mk2.icon = "__Persoport-no-range__/graphics/icons/personal-roboport-mk2-equipment-nr.png";
